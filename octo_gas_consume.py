...
earliest = "2022-11-08T00:00:00Z"
latest = "2022-11-08T23:59:00Z"
...
response_gas_consume = requests.get(f"{base_url}/v1/gas-meter-points/{gas_mprn}/meters/{gas_serial}/consumption/{time_period}", headers=header)
